...
export function getUserInfosMonthly(deviceIdNo) {
  return axios.get(`${USERS_URL}/monthly-info/${deviceIdNo}`);
}

export function getUserInfosIndividual(deviceIdNo) {
  return axios.get(`${USERS_URL}/invidual-info/${deviceIdNo}`);
}

export function getUserIORecords(deviceIdNo) {
  return axios.get(`${USERS_URL}/input-output/${deviceIdNo}`);
}
