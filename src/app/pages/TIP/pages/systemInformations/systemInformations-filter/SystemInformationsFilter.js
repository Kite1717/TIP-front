...
export function SystemInformationsFilter({ listLoading }) {
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(systemInformationsUIProps.queryParams, values);
    if (!isEqual(newQueryParams, systemInformationsUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      systemInformationsUIProps.setQueryParams(newQueryParams);
    }
  };
