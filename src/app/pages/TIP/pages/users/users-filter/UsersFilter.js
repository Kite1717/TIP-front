...
const prepareFilter = (queryParams, values) => {
  const { status, type, deviceIdNo,tcNo } = values;
  ...
  // Filter by all fields
   ...
   filter.deviceIdNo = deviceIdNo !== "" ? deviceIdNo : null
              ...
              <div className="form-group row">
                ...
                <div className="col-lg-2">
                  <input
                    ...
                    placeholder=  {intl.formatMessage({ id: "MENU.SEARCH" })}
                    onBlur={handleBlur}
                    value={values.deviceIdNo}
                    onChange={(e) => {
                      setFieldValue("deviceIdNo", e.target.value);
                  ...
                  <small className="form-text text-muted">
                  {intl.formatMessage({ id: "MENU.USERS.FILTER_BY_DEVICE_ID" })}
                </small>
                </div>
