...
// Validation schema
const NonTipPerformanceEditSchema = Yup.object().shape({
  fullName: Yup.string()
...
export function NonTipPerformanceEditForm({
  saveNonTipPerformance,
  nonTipPerformance,
  actionsLoading,
  onHide,
}) {
  ...
  return (
    <>
      <Formik
        ...
        initialValues={nonTipPerformance}
        validationSchema={NonTipPerformanceEditSchema}
        onSubmit={(values) => {
          saveNonTipPerformance(values);
        }}
      >
