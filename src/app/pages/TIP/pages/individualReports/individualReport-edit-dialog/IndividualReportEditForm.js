...
// Validation schema
const IndividualReportEditSchema = Yup.object().shape({
  fullName: Yup.string()
...
export function IndividualReportEditForm({
  ...
  return (
    <>
      <Formik
        ...
        initialValues={individualReport}
        validationSchema={IndividualReportEditSchema}
        onSubmit={(values) => {
          saveIndividualReport(values);
        }}
      >
