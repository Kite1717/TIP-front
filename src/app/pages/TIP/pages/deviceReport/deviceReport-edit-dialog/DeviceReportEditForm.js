...
// Validation schema
const DeviceReportEditSchema = Yup.object().shape({
  fullName: Yup.string()
...
export function DeviceReportEditForm({
  saveDeviceReport,
  deviceReport,
  actionsLoading,
  onHide,
  ...
  return (
    <>
      <Formik
        ...
        initialValues={deviceReport}
        validationSchema={DeviceReportEditSchema}
        onSubmit={(values) => {
          saveDeviceReport(values);
        }}
      >
