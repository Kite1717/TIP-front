...
// Validation schema
const TIPPerformanceEditSchema = Yup.object().shape({
  fullName: Yup.string()
...
export function TIPPerformanceEditForm({
  saveTIPPerformance,
  tipPerformance,
  actionsLoading,
  onHide,
  ...
  return (
    <>
      <Formik
        ...
        initialValues={tipPerformance}
        validationSchema={TIPPerformanceEditSchema}
        onSubmit={(values) => {
          saveTIPPerformance(values);
        }}
      >
